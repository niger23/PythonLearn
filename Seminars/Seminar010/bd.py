...
def create_table():
    try:
        sqlite_connection = sqlite3.connect('Seminars/Seminar010/monitors.db')
...
def added_element (data):        
    sqlite_connection= sqlite3.connect('Seminars/Seminar010/monitors.db', timeout=20)
    cursor = sqlite_connection.cursor()
...
def load_table ():
    all_data = []
    with sqlite3.connect('Seminars/Seminar010/monitors.db') as db:
